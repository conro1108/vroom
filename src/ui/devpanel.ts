...
const SLIDERS: SliderSpec[] = [
  ...
  { key: "rubberBand", label: "rubber band (behind)", min: 0, max: 0.4, step: 0.02 },
  { key: "rubberBandLead", label: "rubber band (ahead)", min: 0, max: 0.4, step: 0.02 },
  ...
  { key: "boostOffroad", label: "boost grass relief", min: 0, max: 1, step: 0.05 },
  ...
  { key: "rocketSpeed", label: "rocket speed × boosted car", min: 1.05, max: 3, step: 0.05 },
